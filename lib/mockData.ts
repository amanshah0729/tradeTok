...
export const MOCK_POSTS: TradePost[] = [
  {
    ...
    caption: 'HYPE holding strong at $37.83! Hyperliquid ecosystem is on fire 🔥 Next resistance at $42.50. Stop at $35.20 for tight risk management.',
    chartColor: {
      from: '#0d0008',
      to: '#200015',
      candleUp: '#22c55e',
